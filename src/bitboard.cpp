...
U64 pawn_attacks[PLAYER_SZ][BOARD_SZ];
U64 pawn_push[PLAYER_SZ][BOARD_SZ];
U64 pawn_dbl_push[PLAYER_SZ][BOARD_SZ];
U64 between_dia[BOARD_SZ][BOARD_SZ];
U64 between_hor[BOARD_SZ][BOARD_SZ];
U64 coplanar[BOARD_SZ][BOARD_SZ];

const U64 knight_moves[BOARD_SZ] =
{
